...
function createResume(){
	$('#edit_form_resume_create').form('submit', {
		...
		success : function(d) {
			...
			if (json.success) {
				//需要设置简历的id
				$('#resume_jlgl_editDialog').dialog('close');
...
<div id="editResumeInfoTab" class="easyui-tabs" style="width:100%;height:400px;">
		<div title="个人信息" data-options="iconCls:'icon-help'" style="padding:10px">
			 <div align="center" style="padding:20px;">
                <form id="edit_form_resume_create" method="post">
					<table>
					<tr><td><input id="edit_input_resume_id" name="talent.id" hidden="true" /></td></tr>
					<tr>
					...
					<tr>
						...
						<td><input class="easyui-textbox" name="talent.email" style="width:160px;height:24px;" data-options="required:true"/></td>	
						<th>QQ号码</th>
					...
					<tr>
						...
						<td><input class="easyui-textbox" name="talent.profession"  data-options="required:true" style="width:160px;height:24px;"/></td>
						<th>注册情况</th>
					...
					<tr>
						...
						<th>到期日期</th>
						<td><input class="easyui-datebox" name="talent.expireDate" style="width:160px;height:24px;"  /></td>
						<th>备注</th>
